...
// =============================================================================
// Dashboard ATS CHINT — Standalone (no Askama variables)
// =============================================================================
...
/// Page de monitoring ATS CHINT (standalone, données via API JS).
pub async fn dashboard_ats(State(_state): State<AppState>) -> Response {
    render(AtsTemplate {})
}
